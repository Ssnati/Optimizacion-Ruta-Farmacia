...
class EditPopup(tk.Toplevel):
    ...
    def crear_interfaz(self):
        ...
        agregar_producto_button.grid(row=3, column=0, pady=(10, 0))

        # Boton para editar el producto del pedido
        editar_producto_button = tk.Button(self, text="Editar Producto",
                                            command=lambda: self.editar_producto(productos_table))
        editar_producto_button.grid(row=3, column=1, columnspan=2, pady=(10, 0))
        # Boton para eliminar el producto del pedido
        eliminar_producto_button = tk.Button(self, text="Eliminar Producto",
                                            command=lambda: self.eliminar_producto(productos_table))
        eliminar_producto_button.grid(row=3, column=3, pady=(10, 0))
        ...
        agregar_pedido_button = tk.Button(self, text="Guardar Pedido",
    ...
    def editar_producto(self, productos_table):
        print("Editar producto")
        self.refresh_table(self)

    def eliminar_producto(self, productos_table):
